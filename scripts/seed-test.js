...
async function main() {
  ...
  await prisma.teamPayment.createMany({ data: [
    { teamId: teamOrli.id,  season: SEASON, amount: 3000, status: 'PAID',    paidAt: daysAgo(25), method: 'bank', variableSymbol: '900001' },
    { teamId: teamOhen.id,  season: SEASON, amount: 3000, status: 'PENDING', variableSymbol: '900002' },
    { teamId: teamSila.id,  season: SEASON, amount: 3000, status: 'OVERDUE', variableSymbol: '900003' },
    { teamId: teamBoure.id, season: SEASON, amount: 3000, status: 'PENDING', variableSymbol: '900004' },
  ]});
