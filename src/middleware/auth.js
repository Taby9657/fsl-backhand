...
/**
 * Volitelné ověření pro veřejné endpointy, které mají přihlášenému ukázat víc.
 *
 * Chybějící ani neplatný token není chyba — request pokračuje jako anonymní,
 * jen bez `req.user`. Nikdy tedy nesmí vracet 401, jinak by rozbil veřejný web.
 */
async function optionalAuth(req, res, next) {
  ...
  try {
    ...
    // neplatný nebo expirovaný token — pokračujeme jako anonym
  }
